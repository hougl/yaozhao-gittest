...
//			}	
	...
	public static void main(String[] args) {
		String dcppLoginSn = login("zqswsj", "~`", "9bdd0f865c4a370181534e6eda4zq6c2963fc04b", "http://cuc1.sdyypt.net:8060/WebServices/Security.asmx?wsdl");
		//每日限制20次登陆，每次登陆的有效期多久
//		String dcppLoginSn = "6ed49ada-06f4-413c-9bb1-0356931b62a5";
		System.out.println(dcppLoginSn);//0f6869d3-abd4-4b1a-a873-e81d7ac9e699
		String uid = dcppLoginSn;
		String all = encrypt("all","|`WKR#*!");//
		String time = encrypt("20120425000000","|`WKR#*!");
		...
		//组织入参数据：用户名、用户密码、签名
		Object[] opArgs = new Object[] {all, time, uid};
		//动态调用Webservcie  获得serviceResponse
		JaxWsDynamicClientFactory dcf1 = JaxWsDynamicClientFactory.newInstance();
		Client client1 = dcf1.createClient("http://cuc1.sdyypt.net:8060/WebServices/OrderServicesJ.asmx?wsdl",new DcppClassloader());
		//存储serviceResponse
		Object[] ret = null;
	    try {
	    	client1.setThreadLocalRequestContext(true);
	    	ret = client1.invoke("get_nation_drug", opArgs);
		...
		if(ret != null && ret.length != 0) {
			System.out.println("一共有几个参数：" + ret.length);
//			String dcppLoginSn1 = login("zqswsj", "~`", "9bdd0f865c4a370181534e6eda4zq6c2963fc04b", "http://cuc1.sdyypt.net:8060/WebServices/Security.asmx?wsdl");
//			System.out.println(dcppLoginSn1);
		} else {
			//没有返回值，抛出异常
